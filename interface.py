from tkinter import *
from app import gotte_catch_em_all, list_of_pokemon, read_stats
...
def OptionMenu_pokemon_1(event):
    ...
    gotte_catch_em_all(pokemon_1_var.get()) #Controleerd of er al een stats bestand is aangemaakt en maakt deze aan als deze er niet is. voor info zie appp.py
...
def OptionMenu_pokemon_2(event):
    ...
    gotte_catch_em_all(pokemon_2_var.get()) #Controleerd of er al een stats bestand is aangemaakt en maakt deze aan als deze er niet is. voor info zie appp.py
...
#HP Positie
pokemon_1_hp_number = ('')
pokemon_1_hp_number = Label(left, text=''.join(pokemon_1_hp_number), bg='silver')
pokemon_1_hp_number.grid(row=0, column=1, sticky='nw')
pokemon_2_hp_number = ('')
pokemon_2_hp_number = Label(right, text=''.join(pokemon_2_hp_number), bg='silver')
pokemon_2_hp_number.grid(row=0, column=1, sticky='nw')

# Stats positie
pokemon_1_stats = ('')
pokemon_2_stats = ('')
pokemon_1_stats = Label(left, text='\n'.join(pokemon_1_stats), bg='silver')
pokemon_2_stats = Label(right,text='\n'.join(pokemon_2_stats), bg='silver')
...
pokemon_1_move_1 = Button(left, padx=100, pady= 1, text='attack 1', command=p1_attack1, bg='silver')
pokemon_1_move_1.grid(row=3, column=0,sticky=W )

pokemon_1_move_2 = Button(left, padx=100, pady= 1, text='attack 2', command=p1_attack2, bg='silver')
pokemon_1_move_2.grid(row=3, column=1,sticky=W)

pokemon_1_move_3 = Button(left, padx=100, pady= 1, text='attack 3', command=p1_attack3, bg='silver')
pokemon_1_move_3.grid(row=4, column=0, sticky=W)

pokemon_1_move_4 = Button(left, padx=100, pady= 1, text='attack 4', command=p1_attack4, bg='silver')
pokemon_1_move_4.grid(row=4, column=1, sticky=W)

pokemon_2_move_1 = Button(right, padx=100, pady= 1, text='attack 1', command=p2_attack1, bg='silver')
pokemon_2_move_1.grid(row=3, column=0,sticky=W )

pokemon_2_move_2 = Button(right, padx=100, pady= 1, text='attack 2', command=p2_attack2,  bg='silver')
pokemon_2_move_2.grid(row=3, column=1,sticky=W)

pokemon_2_move_3 = Button(right, padx=100, pady= 1, text='attack 3', command=p2_attack3, bg='silver')
pokemon_2_move_3.grid(row=7, column=0, sticky=W)

pokemon_2_move_4 = Button(right, padx=100, pady= 1, text='attack 4', command=p2_attack4, bg='silver')
